...
current_price=2551                   #current market price
marketcap=8264                      #market cap of the company
debt_to_equity= 0.08                   #debt_to equity
roce=50.2                              #ROCE
roe=34.4                             #ROE
pe=20                              #pe ratio of the company
medpe=14.5                             #avg pe of 10Y
pb=5.72                              #PB
medpb=3                          #avg pb of 10y
peg=0.56                            #PEG
inflation=7                         #assumed inflation rate
margin_of_safety=20                    #margin of safety


netprofit=[27,36,31,34,33,58,82,113,117,97,243,418]
cashflow=[14,53,94,111,56,85,60,140,94,144,110,232]
...
plt.savefig('D:\\Financials\\Intrinsic value plots\\%s .jpg'%(company), bbox_inches='tight')
plt.show()