...
current_price=1062                   #current market price
marketcap=288110                      #market cap of the company
debt_to_equity=0.11                    #debt_to equity
roce=25.4                              #ROCE
roe=22                             #ROE
pe=20.8                              #pe ratio of the company
medpe=16.3                             #avg pe of 10Y
pb=4.71                              #PB
medpb=4.2                          #avg pb of 10y
peg=2.23                            #PEG
...
factor=2                   #Will take the future profit growth rates as 1/factor times for uncertainity
time=40                    #total number of years we hope the company will exist
starting_year=2011         #from where the input data array is available

current_year=2023          #Current financial year
